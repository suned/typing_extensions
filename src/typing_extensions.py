...
class AttrSpecName(_Immutable):
    def __init__(self, origin):
        self.__origin__ = origin

    def __repr__(self):
        return f"{self.__origin__.__name__}.name"

    def __eq__(self, other):
        if not isinstance(other, AttrSpecName):
            return NotImplemented
        return self.__origin__ == other.__origin__


class AttrSpecValue(_Immutable):
    def __init__(self, origin):
        self.__origin__ = origin

    def __repr__(self):
        return f"{self.__origin__.__name__}.value"

    def __eq__(self, other):
        if not isinstance(other, AttrSpecValue):
            return NotImplemented
        return self.__origin__ == other.__origin__


class AttrSpec(_DefaultMixin):
    __class__ = typing.TypeVar
    ...
    @property
    def name(self):
        return AttrSpecName(self)

    @property
    def value(self):
        return AttrSpecValue(self)
